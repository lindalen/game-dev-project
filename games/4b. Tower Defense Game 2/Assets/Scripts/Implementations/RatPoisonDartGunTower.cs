...
public class RatPoisonDartGunTower : MonoBehaviour, IAttacker
{
    ...
    public void DamageEnemies()
    {
        ...
        RotateTowardsEnemyLocation(enemiesInRange[0].transform.position);
        attacker.AttackObject(enemiesInRange[0], damage);
        // animation to show gunfire
    }

    private void RotateTowardsEnemyLocation(Vector3 enemyLocation)
    {
        Vector3 relativePos = enemyLocation - transform.position;
